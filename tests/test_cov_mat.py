...
# -- python impl --
from pyvnlb.pylib.py_impl import computeCovMat
from pyvnlb.pylib.py_impl import idx2coords
...
class TestCovMat(unittest.TestCase):
    ...
    def do_run_cov_mat(self,tensors,sigma,in_params,save=True):
        ...
        for pidx in checks:
            ...
            # -- cpp exec --
            cpp_results = pyvnlb.computeCovMat(groupNoisy[:,:,0],rank)
            ...
            # -- compare --
            np.testing.assert_allclose(cpp_cov,py_cov,rtol=5e-7)
