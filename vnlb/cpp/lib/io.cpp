...
int IOReader::fileno() {
    VNLB_THROW_MSG("IOReader does not support memory mapping");
}

int IOWriter::fileno() {
    VNLB_THROW_MSG("IOWriter does not support memory mapping");
}
